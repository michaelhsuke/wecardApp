        ...
        return {
          ...
          link: function (scope, element, attributes) {
            ...
            $img.onload = function () {
              ...
              //}
              //if (imgWidth >= scope.width) {
              //  maxZoomedInLevel = imgWidth / scope.width;
              //} else {
              //
              //}
            ...
            function moveImage(x, y) {
              ...
              ctx.clearRect(0, 0, $canvas.width, $canvas.height);
              console.log('scope: (' + scope.width + ', ' + scope.height + ')');  // todo
            ...
            function zoomImage(val) {
              ...
              console.log('proposedZoomLevel', proposedZoomLevel);  // todo
              if (maxZoomedOutLevel <= 1 || proposedZoomLevel > maxZoomedOutLevel || proposedZoomLevel <=1) {
              ...
              var newYPos = (((proposedZoomLevel - zoom) * scope.width) / 2 + restoreY) * maxZoomedOutLevel / proposedZoomLevel;
              ...
              //
              ctx.restore();
              newYPos += 20 * maxZoomedOutLevel / proposedZoomLevel;
              var newHeight = 150 * maxZoomedOutLevel / proposedZoomLevel;

              ctx.drawImage($img, newXPos, newYPos, tempZoomWidth, newHeight, 0, 20, scope.width, 150);  // todo
              //ctx.beginPath();
              //ctx.strokeStyle = 'rgba(255, 255, 255, 0.6)';
              //ctx.strokeRect(padding / 2, padding / 2, scope.width, scope.height);
              //ctx.stroke();
